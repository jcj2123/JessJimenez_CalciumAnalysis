...
function [boot_rates, signif_thresholds, signif_cell_inds,signif_cell_totals]= bootstrap_rate_selective_cells(behavior, cell, type, threshold,FPS)
...
else    [cellrates_behstates,states,beh_length]=calc_beh_rates_forboot(behavior, cell, type);
