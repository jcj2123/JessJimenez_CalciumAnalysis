...
function[cellrates_behstates,states,beh_length]=calc_beh_rates_forboot_social(behavior, cell, type)
...
[states,numb_beh,beh_length]= define_beh_states_social(behavior,type);
